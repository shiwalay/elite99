...
import { Search, Clock, ArrowRight, Bookmark, Share2, Sparkles, Award } from "lucide-react";
...
export default function BlogPageClient({ initialPosts }: { initialPosts: Post[] }) {
  ...
  useEffect(() => {
    ...
    if (saved && postsVersion === CURRENT_VERSION) {
      ...
      localStorage.setItem("cms_posts_data", JSON.stringify(initialPosts));
            ...
            <div className="sticky top-28 space-y-10">
              ...
              <div className="glass-panel border-slate-800 p-6 rounded-2xl space-y-4">
                <div className="flex items-center gap-3">
                  <div className="h-12 w-12 rounded-full overflow-hidden border border-[#d4af37]/35 shadow-lg">
                    <img
                      src="/swapnil_hero.png"
                      alt="Swapnil Shiwalay"
                      className="h-full w-full object-cover"
                    ...
                    {trendingPosts.map((post, idx) => (
                      <div key={post.slug} className="flex gap-4 items-start">
                        ...
                        <div className="space-y-1">
                          ...
                          <span className="text-slate-555 text-[10px] block font-mono">
